...
public class MovieController {
    ...
    @ApiResponse(responseCode = "200", description = "Retorna todos os filmes cadastrados", content = @Content(schema = @Schema(implementation = MovieResponse.class)))
    @GetMapping()
    ...
    @Operation(summary = "Buscar filme por id", description = "Método responsável por buscar filme por id", security = @SecurityRequirement(name = "bearerAuth"))
